    ...
    <div className="space-y-6">
      <section className="grid gap-4 md:grid-cols-3">
        <div className="rounded-lg bg-white p-5 shadow-sm ring-1 ring-slate-200">
          ...
          <p className="mt-2 text-3xl font-semibold text-slate-950">Starter</p>
          <p className="mt-2 text-sm text-slate-600">£9/month mock subscription</p>
        </div>
        <div className="rounded-lg bg-white p-5 shadow-sm ring-1 ring-slate-200">
          <p className="text-sm font-medium text-slate-500">Usage this month</p>
          <p className="mt-2 text-3xl font-semibold text-slate-950">42 / 100</p>
        ...
        <div className="rounded-lg bg-blue-600 p-5 text-white shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-blue-50">
            Unlock higher usage, Google sync, and multi-location-ready foundations.
          </p>
        </div>
      </section>
