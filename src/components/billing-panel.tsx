      ...
      <section className="grid gap-4 md:grid-cols-3">
        <div className="rounded-lg bg-white p-5 shadow-sm ring-1 ring-slate-200">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Pilot account for Ashpazi and Gardner Champion locations
          </p>
        </div>
        <div className="rounded-lg bg-white p-5 shadow-sm ring-1 ring-slate-200">
        ...
        <div className="rounded-lg bg-blue-600 p-5 text-white shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <p className="font-semibold">Pilot billing paused</p>
          </div>
          <p className="mt-3 text-sm leading-6 text-blue-50">
            These pilot accounts are marked Free Forever while the review inbox
